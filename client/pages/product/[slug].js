...
import { client, urlFor } from "../../config/config";
...
export default function ProductDetails({ product, products }) {
  ...
  const { qty, increaseQty, decreaseQty, onAddItemToCart, setShowCart } = useStateContext();
  const handleBuyNow = () => {
        ...
        <div className="product-detail-container">
          ...
          <div className="product-detail-desc">
            ...
            <div className="buttons">
              <button type="button" className="add-to-cart" onClick={()=> onAddItemToCart(product, qty)}>
                Add to Cart
              </button>
